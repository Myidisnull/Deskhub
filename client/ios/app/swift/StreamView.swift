...
struct StreamView: View {
    ...
    // GĐ10 — ô nhập mật khẩu (passwordOverlay).
    ...
    /// GĐ10 — ô nhập mật khẩu, hiện khi host đòi mà máy này chưa có.
    ///
    ...
    /// challenge của host (docs/04-protocol.md §7b), nên chuỗi này không rời khỏi máy.
