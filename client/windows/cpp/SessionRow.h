...
//
// Là kiểu dữ liệu AgentControl::SetRows dùng để đẩy danh sách nguồn ra cửa sổ
// phiên (SessionWindow — bản cài đặt duy nhất của AgentControl).
// =============================================================================
#include <cstdint>
#include <string>
