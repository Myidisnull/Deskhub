...
//   vì đúng lý do đó (xem core/include/deskhub/discovery/Beacon.h).
//
...
//
// LIÊN QUAN: deskhub/wire/Wire.h (BuildListSources/ParseSourceList),
//            deskhub/discovery/Beacon.h (đầu kia), ClientApi.cpp (người gọi),
