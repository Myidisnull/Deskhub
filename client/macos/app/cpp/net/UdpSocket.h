#pragma once
// =============================================================================
// UdpSocket.h — bọc BSD socket, bản macOS (CHÉP từ client/ios/.../net/UdpSocket.h).
//
// NHIỆM VỤ
...
//   API ở đây GIỮ NGUYÊN từng chữ so với bản iOS/Android và bản Windows — macOS,
//   iOS và Android đều POSIX nên file này chép nguyên (docs/11 §5: "native
//   mac/iOS/Linux dùng lại UdpSocket của Android").
//
...
//   người gọi trực tiếp nó — trên macOS là CẢ HAI VAI (ClientLoop và AgentLoop).
//
// QUY ƯỚC ĐỊA CHỈ
...
//
// LIÊN QUAN: client/ios/.../net/UdpSocket.h (bản song song, cùng API),
//            net/SourceQuery.h, client/ClientLoop.h, agent/AgentLoop.h (người dùng)
// =============================================================================
#include <cstdint>
#include <string>
