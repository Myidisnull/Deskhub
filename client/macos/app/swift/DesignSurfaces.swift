...
// (chấm sống, pill, khối số, biểu đồ độ trễ, vòng quay).
//
// MỌI BỀ MẶT LÀ MỘT LỚP KÍNH, KHÔNG PHẢI MÀU ĐẶC
//   Ở nền tối, card/rail/HUD đều là một lớp trắng MỜ chồng lên nền gần-đen; chồng lớp
//   chính là thứ tạo ra chiều sâu ở đây. Chỉ cửa sổ và HUD nổi mới đổ bóng.
//
...
// HUD: thanh nổi trên video. Đây và cửa sổ là hai thứ DUY NHẤT đổ bóng.
...
// đây là số để LIẾC, không phải để đọc từng chữ. Phông hiển thị ở cỡ 34 dễ bắt hơn
// nhiều, và các cột số này không cần thẳng hàng với nhau như trong một bảng.
//
// `accent` chỉ dùng cho ĐÚNG MỘT số mỗi nhóm — số quan trọng nhất; tô hết thì không
// còn số nào nổi bật.
...
// người dùng mở biểu đồ ra để xem.
