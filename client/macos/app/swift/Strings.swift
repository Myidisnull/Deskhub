...
enum Strings {
    ...
    private static let en: [String: String] = [
        ...
        "shareBody": "Choose the displays another machine may see.",
        ...
        "streaming": "streaming",
        "idle": "idle",
        "noSources": "No display found.",
        "sharedCountFmt": "%d of %d shared",
        "shareFailed": "Could not start sharing. The display may be disconnected, or the port is in use.",
    ...
    private static let vi: [String: String] = [
        ...
        "shareBody": "Chọn màn hình mà máy khác được xem.",
        ...
        "idle": "chưa bật",
        "noSources": "Không thấy màn hình nào.",
        "sharedCountFmt": "đang chia sẻ %d/%d",
        "shareFailed": "Không bắt đầu chia sẻ được — màn hình có thể đã bị rút, hoặc cổng đang bận.",
