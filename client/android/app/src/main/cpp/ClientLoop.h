...
public:
    ...
    // kho an toàn của nền tảng (EncryptedSharedPreferences) rồi truyền vào Start.
    struct Credentials {
        ...
        // lần rồi lưu — xem Credentials.kt.
        uint32_t clientId = 0;
        // Tên hiện ở danh sách "Trusted devices" phía host ("Pixel 8").
    ...
    // một lần. Caller lưu kèm địa chỉ host để lần sau khỏi hỏi mật khẩu.
