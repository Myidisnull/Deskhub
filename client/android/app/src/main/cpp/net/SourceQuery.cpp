// =============================================================================
// SourceQuery.cpp — cài đặt vòng hỏi-đáp LIST_SOURCES.
//
...
//   ngủ quên trong recvfrom và bỏ lỡ thời điểm phát lại. Đây là kiểu bố trí quen
//   thuộc: một hạn chờ ngắn để vòng lặp luôn "thức" đủ nhanh mà phục vụ các mốc
//   thời gian khác của nó.
//
// TRẢ VỀ NGAY KHI CÓ CÂU TRẢ LỜI ĐẦU TIÊN
//   Không chờ hết 3 giây để gom thêm — SOURCE_LIST mang trọn danh sách trong một
//   datagram, nên gói thứ hai (nếu host phát lại) cũng chỉ nói đúng chừng ấy.
//
