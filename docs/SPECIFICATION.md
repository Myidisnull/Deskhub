...
port the network scan knocks on — and clipboard sync (T-17), plus the passcode (T-5) and
the network to share on (T-9) on their sharing screen; they host with the built-in
