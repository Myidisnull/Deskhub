...
| C-10 | Kết nối rồi mới chọn | Nút Connect chỉ làm việc xác thực: nó gọi tới host, hoàn tất ghép đôi hoặc passcode (S-2), và hỏi host đang chia sẻ những gì. Cho tới khi bước đó thành công, trang chỉ gồm các ô địa chỉ, cổng, passcode và tên, nút Connect, và danh sách thiết bị — không có gì khác. Khi host trả lời, những thứ đó nhường chỗ cho địa chỉ của nó, nút **Ngắt kết nối**, dòng trực tiếp của V-7, và mỗi khả năng một nút: *Remote desktop — view its screen*, *Terminal — open a shell* và *File transfer — send files to it*, mỗi nút chỉ bật nếu host có chia sẻ khả năng tương ứng. Ngắt kết nối, hoặc sửa địa chỉ, cổng hay passcode, đưa trang về trạng thái đầu. Mở một phiên dùng lại chính lần ghép đôi vừa xong, nên không ai ở phía host bị hỏi lần thứ hai. |
