...
inline constexpr LStr kFpsLabel{"FPS"};
inline constexpr LStr kBitrateMbpsLabel{"Bitrate (Mbps)"};
inline constexpr LStr kQualityLabel{"Quality"};
inline constexpr LStr kQualityNativeLabel{"Native"};
inline constexpr LStr kOpenSystemSettingsLabel{"Open Settings"};
