...
void TestTheReadingsTurnIntoWords() {
    ...
    Check(std::string(ui::LinkQualityText(LinkQuality::Good)) == ui::kLinkQualityGood.get(),
        "good has its word");
    Check(std::string(ui::LinkQualityText(LinkQuality::Fair)) == ui::kLinkQualityFair.get(),
        "fair has its word");
    Check(std::string(ui::LinkQualityText(LinkQuality::Poor)) == ui::kLinkQualityPoor.get(),
        "poor has its word");
    Check(std::string(ui::LinkQualityText(LinkQuality::Unknown)) == ui::kLinkNoReading.get(),
    ...
    Check(ui::LinkPingText(false, 0) == ui::kLinkNoReading.get(),
