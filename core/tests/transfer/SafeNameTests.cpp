...
void TestOrdinaryNamesSurvive() {
    ...
    Check(SafeFileName("\xe1\xba\xa2nh ch\xe1\xbb\xa5p m\xc3\xa0n h\xc3\xacnh.png") ==
              "\xe1\xba\xa2nh ch\xe1\xbb\xa5p m\xc3\xa0n h\xc3\xacnh.png",
...
void TestLongNamesAreShortened() {
    ...
    std::string accented;
    static constexpr char kUtf8Accent[] = {'\xe1', '\xbb', '\xa9', '\0'};
    for (int i = 0; i < 200; ++i) accented += kUtf8Accent;
