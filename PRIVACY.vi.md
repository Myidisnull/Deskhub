...
_Ngày hiệu lực: 7 tháng 9, 2026 — Phiên bản 2.5_
...
|---|---|---|
| 2.5 | 2026-09-07 | Đây là đính chính, không phải thay đổi — Deskhub vẫn hoạt động y như trước. Các bản trước của chính sách này nói tệp đến một điện thoại hay máy tính bảng Android sẽ vào `Pictures/Deskhub`, `Movies/Deskhub` hoặc `Download/Deskhub` qua kho media của hệ thống. Điều đó đúng trên Android 10 trở lên. Đường qua kho media mà Deskhub dùng cần Android 10, nên trên Android 9 trở về trước, tệp đến ở lại trong thư mục riêng của app trên thiết bị và không bao giờ hiện trong thư viện ảnh hay trong Downloads. Dù thế nào thì nó cũng không tới ai ngoài hai thiết bị liên quan. |
