...
struct HostNetLoopHooks {
    ...
    std::function<void(const NetAddr& from, std::span<const uint8_t> datagram)> onTerminal;
    std::function<void(const NetAddr& from, std::span<const uint8_t> datagram)> onPairing;
